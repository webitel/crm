...
const authURL = import.meta.env.VITE_AUTH_MODULE_URL;
...
export default {
  ...
  mounted() {
    console.log('authURL:', authURL, 'process:', process, 'process.env.VUE_APP_AUTH_MODULE_URL:', process.env.VUE_APP_AUTH_MODULE_URL);
