...
.addFilter([
  {
    name: 'type',
    value: [TimelineEventType.Call, TimelineEventType.Chat, TimelineEventType.Email],
    defaultValue: [TimelineEventType.Call, TimelineEventType.Chat, TimelineEventType.Email],
    multiple: true,
  },
])
.getModule();
